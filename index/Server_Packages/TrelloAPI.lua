...
local T = {}
if script:GetAttribute("Token")==nil and key=="Here!" and getfenv(0).token==nil then
...
while script:GetAttribute("Token")==nil and getfenv(0).token==nil do
	wait()
end
local token=script:GetAttribute("Token")..""
function getAddon()
	if token~="" then
